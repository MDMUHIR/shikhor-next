...
export const COURSES: Course[] = [
  {
    ...
    demoVideos: [
      ...
      },
      {
        ...
        youtubeId: 'vhsWdQsJgmk',
        thumbnail: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?w=600&auto=format&fit=crop&q=80',
        duration: '45:10',
      },
    ],
    titleBn: 'এইচএসসি ২৮ পিসিএমবি ১ম পত্র কম্বো কোর্স',
    shortDescriptionBn: 'এইচএসসি ২৮ ব্যাচের জন্য পদার্থবিজ্ঞান, রসায়ন, উচ্চতর গণিত ও জীববিজ্ঞানের ১ম পত্রের সম্পূর্ণ প্রস্তুতি।',
    isPopular: true,
  },
  {
    id: 'hsc-28-ebi-combo',
    ...
    titleBn: 'এইচএসসি ২৮ ইংরেজি, বাংলা, আইসিটি (ইবিআই ২.০) ব্যাচ',
    shortDescriptionBn: 'এইচএসসি ২৮ ব্যাচের ইংরেজি, বাংলা ও আইসিটির ১ম ও ২য় পত্রের সম্পূর্ণ প্রস্তুতি।',
    isPopular: true,
    isNew: true,
  },
  {
    ...
    titleBn: 'এসএসসি ২৭ বিজ্ঞান ফাউন্ডেশন ও বোর্ড প্রস্তুতি',
    shortDescriptionBn: 'পদার্থবিজ্ঞান, রসায়ন, সাধারণ গণিত ও উচ্চতর গণিতসহ নবম-দশম শ্রেণির বিজ্ঞান বিভাগের সম্পূর্ণ প্রস্তুতি।',
    isPopular: false,
    isNew: true,
  },
  {
    ...
    titleBn: 'বুয়েট ও মেডিকেল ভর্তি ইঞ্জিনিয়ারিং ফিজিক্স এবং কেমিস্ট্রি মাস্টারি',
    shortDescriptionBn: 'অ্যাডভান্সড সমস্যা সমাধান, কনসেপ্ট ডিপ-ডাইভ এবং বুয়েট, চুয়েট, রুয়েট ও মেডিকেল মানের প্রশ্নব্যাংক প্রস্তুতি।',
    isPopular: true,
  },
];
